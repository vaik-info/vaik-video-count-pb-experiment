...
def dump(json_dict, classes, answer_count_list, pred_count, skip_frame, distribution_dict, prefix):
...
def calc_count_distribution_mse(json_dict_list, classes, skip_frame):
    ...
    for json_dict in json_dict_list:
        ...
        for grad_index, grad_cam in enumerate(json_dict['grad_cam']):
            ...
            grad_mse = dump(json_dict, classes, answer_count_list, pred_count, skip_frame, distribution_dict, f'grad{grad_index:02d}')

...
def save_gif(pred_frames, frames, classes, colors, json_dict, output_dir_path, prefix):
    canvas_image_list = []
...
def main(input_json_dir_path, input_classes_path, output_dir_path):
    ...
    for json_dict in json_dict_list:
        ...
        for grad_index, grad_cam in enumerate(json_dict['grad_cam']):
            ...
            save_gif(pred_frames, frames, classes, colors, json_dict, output_dir_path, f'{grad_index:02d}')
